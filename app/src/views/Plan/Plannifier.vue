          ...
          <a-col :span="24">
            <a-card title="" :bordered="false" style="margin-top: 24px; margin-bottom: 24px">
                ...
                <a-row>
                    <a-col :span="12" :offset="6">
                        <a-row>
                        <a-form :form="form" @submit="handleSubmit" v-if="steps[current].content === 'First-content'">
                        ...
                        <a-form :form="form" @submit="handleSubmit" v-if="steps[current].content === 'Second-content'">
